...
###
###
###imageNumberSound("roomsitems", 9,  "diningroom")
###imageNumberSound("roomsitems", 3,  "shower")
###imageNumberSound("roomsitems", 7,  "garage")
###imageNumberSound("roomsitems", 5,  "kitchen")
###imageNumberSound("roomsitems", 2,  "sofa")
###imageNumberSound("roomsitems", 6,  "hall")
###imageNumberSound("roomsitems", 1,  "toilet")
###imageNumberSound("roomsitems", 4,  "livingroom")
###imageNumberSound("roomsitems", 8,  "fridge")
###imageNumberSound("roomsitems", 15, "basement")
###imageNumberSound("roomsitems", 11, "clock")
###imageNumberSound("roomsitems", 14, "bathroom")
###imageNumberSound("roomsitems", 12, "bedroom")
###imageNumberSound("roomsitems", 13, "bed")
###imageNumberSound("roomsitems", 10, "cooker")
###
###
###
###
...
#
#
#imageNumberSound("seasons", 4,  "winter")
#imageNumberSound("seasons", 1,  "spring")
#imageNumberSound("seasons", 3,  "autumn")
#imageNumberSound("seasons", 2,  "summer")
#
#imageNumberSound("seasons", 3,  "autumn")
#imageNumberSound("seasons", 2,  "summer")
#imageNumberSound("seasons", 4,  "winter")
...
#
#
#imageNumberSound("clothes", 7,  "shirt")
#imageNumberSound("clothes", 3,  "skirt")
#imageNumberSound("clothes", 8,  "tshirt")
#imageNumberSound("clothes", 6,  "coat")
#imageNumberSound("clothes", 1,  "shoes")
#imageNumberSound("clothes", 2,  "shorts")
#imageNumberSound("clothes", 4,  "jumper")
#imageNumberSound("clothes", 5,  "trousers")
#
#
#
#imageNumberSound("clothes", 4,  "jumper")
...
imageNumberSound("games", 7,  "tag")
imageNumberSound("games", 3,  "cards")
imageNumberSound("games", 8,  "football")
imageNumberSound("games", 6,  "hopscotch")
imageNumberSound("games", 1,  "basketball")
imageNumberSound("games", 2,  "boardGame")
imageNumberSound("games", 4,  "hideAndSeek")
imageNumberSound("games", 5,  "computerGame")


imageNumberSound("places", 3,  "gym")
imageNumberSound("places", 1,  "playground")
imageNumberSound("places", 5,  "library")
imageNumberSound("places", 2,  "corridor")
imageNumberSound("places", 4,  "canteen")
imageNumberSound("places", 6,  "classroom")

def trueStatement(name, number, audio):
    os.system("kitty +kitten icat " + "images/" + "TrueOrFalse.png")
    while True:
        global correct, wrong
        #os.system("kitty +kitten icat " + "images/" + name + ".png")
        os.system("mpg123 -q " + "audio/" + "TrueOrFalse.mp3" )
        os.system("mpg123 -q " + "audio/" + audio + ".mp3" + "&")
        print(name.upper())
        input_number=input(":")
        try:
          input_number = int(input_number)
        ...
        if input_number == 1:
           ...
           break
            ...
            print("Try again")
            os.system("mpg123 -q " + sprobuj_ponownie) 
            trueStatement(name, number, audio)
            wrong += 1

def falseStatement(name, number, audio):
    os.system("kitty +kitten icat " + "images/" + "TrueOrFalse.png")
    while True:
        global correct, wrong
        #os.system("kitty +kitten icat " + "images/" + name + ".png")
        ...
        if input_number == 2:
           ...
           break
            ...
            print("Try again")
            os.system("mpg123 -q " + sprobuj_ponownie) 
            falseStatement(name, number, audio)
            wrong += 1



trueStatement("frog", 1, "bclassroom")

falseStatement("frog", 2, "bcanteen")

trueStatement("frog", 1, "fg")

falseStatement("frog", 2, "bcorridor")

falseStatement("frog", 2, "bgym")

falseStatement("frog", 2, "blibrary")

falseStatement("frog", 2, "bplay")

falseStatement("frog", 2, "fc")

falseStatement("frog", 2, "fcan")

falseStatement("frog", 2, "fclass")

falseStatement("frog", 2, "fl")
falseStatement("frog", 2, "fp")




print("Poprawne odpowiedzi: " + str(correct))
print("Błędne odpowiedzi: " +  str(wrong))

#imageNumberSound("animals2", 3, "crocodile")
#imageNumberSound("animals2", 5, "giraffe")
#imageNumberSound("animals2", 2, "mouse")
#imageNumberSound("animals2", 9, "monkey")
#imageNumberSound("animals2", 6, "parrot")
#imageNumberSound("animals2", 1, "frog")
#imageNumberSound("animals2", 4, "tiger")
#imageNumberSound("animals2", 7, "elephant")
#imageNumberSound("animals2", 8, "snake")
#
#
#
#imageNumberSound("activities", 5, "run")
#imageNumberSound("activities", 2, "climb")
#imageNumberSound("activities", 3, "walk")
#imageNumberSound("activities", 4, "jump")
#imageNumberSound("activities", 1, "fly")
#
#imageNumberSound("activities", 2, "climb")
#imageNumberSound("activities", 4, "jump")
#imageNumberSound("activities", 5, "run")
...
#
#
#trueStatement("frog", 1, "FrogsCanJump")
#
#trueStatement("frog", 1, "FrogsCanSwim")
#
#
#
#trueStatement("", 1, "")
...
#falseStatement("parrot", 2, "ParrotCanSwim")
#trueStatement("parrot", 1, "ParrotCanFly")
#
#trueStatement("tiger", 1, "TigerCanHount")
#trueStatement("tiger", 1, "TigerCanJump")
#
#
#falseStatement("snake", 2, "SnakeCanWalk")
#
#
#trueStatement("monkey", 1, "MonkeyCanClimb")
#
#trueStatement("crocodile", 1, "CrocodileCanDive")
#
#
#
#
